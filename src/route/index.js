...
router.get('/template-3', function (req, res) {
  ...
  res.render('template-3', {
    ...
    hero: {
      ...
      photo:
        'https://bipbap.ru/wp-content/uploads/2018/06/girl-500x500.jpg',
    },
    ...
    blog: [
      {
        ...
        img: 'https://www.zir.com.ua/wp-content/uploads/2021/10/unnamedkkkkkk-140x140.jpeg',
      },
      {
        title: 'Featured story',
        text: 'This is a wider card with supporting text below as a natural lead-in to additional content',
...
router.get('/template-7', function (req, res) {
  ...
  res.render('template-7', {
    ...
    hero: {
      ...
      description:
        'I am incredibly grateful for the outstanding work done by this team. Their promptness and attention to details.',
      button: {
